...
df3 = df3[['id','label']]
# 保存结果文件
df1.to_csv('./90.00586.csv', index=False)
df2.to_csv('./89.98074.csv', index=False)
df3.to_csv('./89.95682.csv', index=False)

# 筛选多份提交结果文件中预测相同的部分
result_path   = '90.00586.csv'
...
t3 = t3[['text_a','label']]
t3.to_csv('newtest3.csv',index=False,sep=',')
print('Done!')